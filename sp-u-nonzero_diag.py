...
parser.add_argument("-weight", dest="diag_weight", help="weight on diagonals", default=0)
...
if __name__ == "__main__":
    ...
    for N in Nvalues:
        is_spatial = 1
        W = generate_weights(N,is_spatial,diag_weight)
        time_steps_M = 100000
        time_steps_B = 100000
        ...
        with open('/storage/home/hcoda1/7/vsivaraman3/p-smaguluri3-0/spatial-matching-sim-vishal/sim_paths_spatial_uniform_' + str(N) +'_W_' + str( W[0][0] )  + '.pkl', 'wb') as f:  
        # with open('./sim_paths_spatial_uniform_' + str(N) +'_W_' + str( W[0][0] )  + '.pkl', 'wb') as f: 

...
for N in Nvalues:
    ...
    Tbatches = np.array([1, 10, 50, 100, 1000, 1500, 2500, 4000])
    Tbatches = np.append(Tbatches,np.arange(5000, 100001, 5000))
    alpha_values = np.array([0, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45,0.46, 0.47, 0.48, 0.49, 0.5, 0.55, 0.6, 0.65, 0.675, 0.7, 0.725, 0.75, 0.8, 0.825, 0.85, 0.875,  0.9
, 0.925, 0.95, 0.954, 0.958, 0.962, 0.966, 0.97, 0.974, 0.978, 0.982, 0.986, 0.99 ])
    ...
    with open('/storage/home/hcoda1/7/vsivaraman3/p-smaguluri3-0/spatial-matching-sim-vishal/lspu_' + str(N) + 'largeq_random.pkl', 'wb') as f:  

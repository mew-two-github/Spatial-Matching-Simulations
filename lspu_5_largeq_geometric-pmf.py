...
for N in Nvalues:
    ...
    with open('/storage/home/hcoda1/7/vsivaraman3/p-smaguluri3-0/spatial-matching-sim-vishal/lspu_' + str(N) + '_largeq_geometric.pkl', 'wb') as f:  
